...
from model.build_global_model import Densenet121_AG, Fusion_Branch, DenseNet121, Convnext_base, Pyconv_densenet121, Vision_transformer
...
def train(args):
    ...
    Global_Branch_model = Vision_transformer(pretrained = args.pretrained, num_classes = N_CLASSES).cuda()
