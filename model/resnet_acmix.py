...
def _resnet(arch, block, layers, pretrained: bool = False, progress: bool = True, **kwargs):
...
def ACmix_ResNet(layers=[3, 4, 6, 3], pretrained: bool = False, progress: bool = True, **kwargs):
    return _resnet('resnet50', Bottleneck, layers, pretrained, progress, **kwargs)
